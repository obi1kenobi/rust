...
//@ has "$.index[?(@.name=='where_clase')].inner.function.generics.where_predicates[0].bound_predicate.implied_bounds[?(@.trait_bound.trait.path=='Foo')]"
//@ has "$.index[?(@.name=='where_clase')].inner.function.generics.where_predicates[0].bound_predicate.implied_bounds[?(@.trait_bound.trait.path=='Sized')]"
